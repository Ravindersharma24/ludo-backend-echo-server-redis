...
<div class="card">
    <div class="card-header">
        <h4>All Battle Transactions {{ trans('global.list') }}</h4>
    ...
    <div style="display: flex" class="transaction-filter">
        ...
        <div>
            <table class=" table table-bordered table-striped table-hover datatable" id="battle-transactions-table">
                <thead>
                    <tr>
                        <th>
                            Username
...
<script>
    $(document).ready(function() {
        var table = $('#battle-transactions-table').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            aaSorting: [],
            ajax: {
                url: "{!! route('admin.ajax.datatable', ['type'=>'battle_transaction']) !!}",
                data: function (d) {
            ...
            columns: [

                {
                    ...
                    render: function (data, type, full, meta) {
                        return "<a class='text-primary' href='battle_transactions/"+full.user_id+"'>"+data+"</a>";
                },
                },
                {
                    data: 'phone_no',
