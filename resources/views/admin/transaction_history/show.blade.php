...
<div class="card outer-card">
    <div class="card-header" style="display: flex;justify-content: space-between;">
        <div class="left_sec" style="display: flex;align-items:center">
            <a href="{{ route('admin.transactions.index') }}" class="btn btn-primary text-light">Back</a>
            <h4 style="text-transform: capitalize" class="ml-4">{{ $user_data->name }} Transaction History</h4>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#transactions-table').DataTable({
            ...
            aaSorting: [],
            ajax: {
                url: "{!! route('admin.ajax.datatable', ['type'=>'user_transaction']) !!}",
