...
<div class="card">
    <div class="card-header d-flex">
        ...
        <h4 class="ml-4">{{ trans('global.edit') }} {{ trans('global.user.title_singular') }}</h5>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.users.update", [$user->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('phone_no') ? 'has-error' : '' }}">
                ...
                <input type="text" id="phone_no" name="phone_no" class="form-control" value="{{ old('phone_no', isset($user) ? $user->phone_no : '') }}">
