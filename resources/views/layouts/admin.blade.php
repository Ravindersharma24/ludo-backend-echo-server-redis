...
<head>
    ...
    <link href="{{ asset('storage/css/all.css') }}" rel="stylesheet" />
    <!-- <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet" /> -->
    <link href="{{ asset('storage/css/select2.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/jquery.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/dataTables.bootstrap4.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/select.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/buttons.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/dropzone.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/app.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/css.css') }}" rel="stylesheet" />

    <link href="{{ asset('storage/css/adminltev3.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/custom.css') }}" rel="stylesheet" />
    <link href="{{ asset('storage/css/bootstrapToggle.css') }}" rel="stylesheet" />
...
<body class="sidebar-mini sidebar-open" style="height: auto;">
    ...
    <script src="{{ asset('storage/js/select2.full.min.js') }}"></script>
    <script src="{{ asset('storage/js/moment.min.js')}}"></script>
    ...
    <script src="{{ asset('storage/js/dataTables.buttons.min.js')}}"></script>
    <script src="{{ asset('storage/js/dataTables.select.min.js')}}"></script>
    <script src="{{ asset('storage/js/buttons.flash.min.js')}}"></script><!-- Not handle -->
    <script src="{{ asset('storage/js/buttons.html5.min.js')}}"></script>
    <script src="{{ asset('storage/js/buttons.print.min.js')}}"></script>
    <script src="{{ asset('storage/js/buttons.colVis.min.js')}}"></script>
    <script src="{{ asset('storage/js/pdfmake.min.js')}}"></script>
    <script src="{{ asset('storage/js/vfs_fonts.js')}}"></script>
    <script src="{{ asset('storage/js/jszip.min.js')}}"></script><!-- Not handle -->
    <script src="{{ asset('storage/js/ckeditor.js')}}"></script>
    <script src="{{ asset('storage/js/moment.min.js')}}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/js/bootstrap-datetimepicker.min.js"></script>
    <script src="{{ asset('storage/js/select2.full.min.js')}}"></script>
    <script src="{{ asset('storage/js/dropzone.min.js')}}"></script>
    <script src="{{ asset('storage/js/main.js') }}"></script>
    <script src="{{ asset('storage/js/bootstrapToggle.js') }}"></script>
